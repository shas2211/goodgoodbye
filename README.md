# goodgoodbye
Hello ppl,
heres the entire code just download the code snippet , paste in the vs code or whatever u use and install the required packages .
Annnd run the code it may take a bit time to load but dont worry it works fine as wine.
